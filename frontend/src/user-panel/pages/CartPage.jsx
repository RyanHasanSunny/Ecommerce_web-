        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm md:text-base">Loading your cart...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 md:p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 text-sm md:text-base">Add some products to get started!</p>
            <Link
              to="/products"
              className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm md:text-base"
            >
    ...
    <div className="min-h-screen item-center bg-gray-50">
      <div className="container mx-auto px-4 py-6 md:py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 md:mb-8 gap-4">
          ...
          <span className="text-gray-600 text-sm md:text-base">({cartItems.length} items)</span>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm">
              <div className="p-4 md:p-6 border-b border-gray-200 flex items-center justify-between">
                <h2 className="text-base md:text-lg font-semibold text-gray-900">Cart Items</h2>
                <button
                  onClick={clearCart}
                  disabled={updating}
                  className="text-red-600 hover:text-red-700 text-xs md:text-sm font-medium disabled:opacity-50"
                >
                  Clear All
                </button>
              </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                            <div className="flex-1">
                              <h3 className="text-sm md:text-base lg:text-lg font-medium text-gray-900 mb-1">
                                <Link
                              ...
                              {product.companyName && (
                                <p className="text-xs md:text-sm text-gray-600 mb-2">{product.companyName}</p>
                              )}
                              ...
                              {product.stock !== undefined && (
                                <>
                                  {product.stock <= 5 && product.stock > 0 && (
                                    <p className="text-xs md:text-sm text-orange-600 mb-2">
                                      Only {product.stock} left in stock!
                                    </p>
                                  )}
                                  {product.stock === 0 && (
                                    <p className="text-xs md:text-sm text-red-600 mb-2">Out of stock</p>
                                  )}
                                </>
                              )}
                            </div>
                            ...
                            <div className="flex items-center space-x-2 sm:flex-col sm:space-x-0 sm:space-y-2">
                              ...
                              <button
                                ...
                                disabled={updating}
                                className="p-1.5 md:p-2 text-gray-400 hover:text-red-500 transition-colors disabled:opacity-50"
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-4 gap-4">
                            <div className="flex items-center border border-gray-300 rounded-lg w-fit">
                              <button
                                ...
                                className="p-1.5 md:p-2 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                              >
                                <Minus className="w-3 h-3 md:w-4 md:h-4" />
                              </button>
                              <span className="px-3 md:px-4 py-1.5 md:py-2 font-medium min-w-[50px] md:min-w-[60px] text-center text-sm md:text-base">
                                {updating ? '...' : quantity}
                              </span>
                              <button
                                onClick={() => updateQuantity(itemId, quantity + 1)}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 sticky top-4">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-2.5 md:py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed mb-4 text-sm md:text-base"
              >
              ...
              <div className="space-y-2 text-xs md:text-sm text-gray-600">
                <div className="flex items-center">
                  <Shield className="w-3 h-3 md:w-4 md:h-4 mr-2 flex-shrink-0" />
              ...
              <div className="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-gray-200">
                <Link
                  to="/products"
                  className="block w-full text-center py-2 px-4 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors text-xs md:text-sm"
                >
                  Continue Shopping
                </Link>
              </div>
